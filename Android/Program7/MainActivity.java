package com.example.facebookfirst;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if(view.getId() == R.id.logbtn){
            if(email.getText().toString().equals("nikhila@gmail.com") && pass.getText().toString().equals("nikhila")){
                ...
                t1.setGravity(Gravity.TOP,20,200);
                t1.setView(appear);
                t1.show();
            }
            else
